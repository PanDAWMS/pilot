...
class aria2cSiteMover(SiteMover.SiteMover):
	...
	srmhost=None
        ...
        cmd = "curl -H \"%s\" -H 'Accept: application/metalink4+xml'  --cacert /etc/pki/tls/certs/CERN-bundle.pem https://voatlasrucio-server-prod.cern.ch/replicas/%s/%s?select=geoip"%(token_rucio,reps[0].scope,reps[0].filename)
