...
class FileState:
    ...
    "file_state" can assume the following values for "input" files:
      ...
      "transferred"     : file has already been transferred (no further action)
      "direct_access"   : file will not be transferred since it will be accessed remotely
      "prefetch"        : file will not be transferred since it will accessed by the Prefetcher
