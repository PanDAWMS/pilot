...
class RunJobNormal(RunJob):

    # private data members
    __runjob = "Normal2"                         # String defining the sub class
...
#    __error = PilotErrors()                     # PilotErrors object
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if not cls.__instance:
            cls.__instance = super(RunJobNormal, cls).__new__(cls, *args, **kwargs)
    ...
    def getRunJobFileName(self):
        ...
        return super(RunJobNormal, self).getRunJobFileName()
