...
class ThreadPool:
    ...
    def add_task(self, func, *args, **kargs):
        reqs = makeRequests(func, args_list=[(args, kargs)])
        for req in reqs:
            self.putRequest(req)
...
def test_operation(test1, test2, test3):
    print test1
    print test2
    print test3
...
if __name__ == "__main__":
    ...
    threadpool.add_task(test_operation, 'test1', 'test2', 'test3') 
